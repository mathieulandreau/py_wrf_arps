...
Note Mathieu Landreau: This class has been written by Yannick Copin and slightly 
modified by Mathieu Landreau. Original work is on Github :
https://gist.github.com/ycopin/3342888
Note Yannick Copin: If you have found these software useful for your research, I would
...
class TaylorDiagram(object):
    ...
    def __init__(self, refstd,
                 fig=None, rect=111, label='_', srange=(0, 1.5), extend=False, unit=None):
        """
        ...
        * extend: extend diagram to negative correlations
        ...
        if unit is None :
            ...
            ax.axis["left"].label.set_text(f"Standard deviation {unit}")
