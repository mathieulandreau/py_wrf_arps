...
def plot_Lumley_tri(method='w/o data', coors=None, fig=None):
    '''
...
def plot_turb_tri(method='w/o data', coors=None, fig=None):
    '''
...
def plot_bary_tri_colormap(c_off=0.65,c_exp=5,nsample=60, fig=None):
    '''
